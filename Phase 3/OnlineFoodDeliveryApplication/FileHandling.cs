...
namespace OnlineFoodDeliveryApplication
{
    public class FileHandling
    {
        public static void Create()
        {
            ...
            if(!File.Exists("DataFolder/CustomerDetails.csv"))
            {
                File.Create("DataFolder/CustomerDetails.csv").Close();
            }
            if(!File.Exists("DataFolder/FoodDetails.csv"))
            {
                File.Create("DataFolder/FoodDetails.csv").Close();
            }
            if(!File.Exists("DataFolder/ItemDetails.csv"))
            {
                File.Create("DataFolder/ItemDetails.csv").Close();
            }
        ...
        public static void WriteToCSV()
        {
            ...
            File.WriteAllLines("DataFolder/CustomerDetails.csv",customers);
            ...
            File.WriteAllLines("DataFolder/FoodDetails.csv",foods);
            ...
            File.WriteAllLines("DataFolder/ItemDetails.csv",items);
        ...
        {
            string [] customers = File.ReadAllLines("DataFolder/CustomerDetails.csv");
            ...
            string[] foods = File.ReadAllLines("DataFolder/FoodDetails.csv");
            ...
            string[] items = File.ReadAllLines("DataFolder/ItemDetails.csv");
