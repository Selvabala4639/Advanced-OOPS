...
class Program
{
    public static void Main(string[] args)
    {
        ...
        EmployeeDetail employee = new EmployeeDetail(student.StudentID, student.UserID, student.UserName, student.FatherName, student.Gender, student.PhoneNumber,  student.Standard,  student.JoiningYear, "Software Developer");
